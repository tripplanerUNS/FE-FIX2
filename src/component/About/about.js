...
import Baliawesome2 from "../../Assets/BALI - awesome waterfalls near UBUD2.jpeg";
    ...
    <div className="box">
      <div className="group">
        <div className="tentang-kami">
          ...
          <img className="img" alt={Baliawesome1} src="BALI-awesome waterfalls near UBUD1.jpeg" />
          <img className="img" alt={Baliawesome2} src="BALI-awesome waterfalls near UBUD2.png" />
          <p className="div">
